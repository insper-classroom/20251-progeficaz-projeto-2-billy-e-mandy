...
def test_get_imoveis_por_tipo(mock_connect_db, client):
    ...
    # Verificamos se os dados retornados estão corretos
    expected_response = {
        "imoveis": {"id": 2, "logradouro": "Sem Saída", "tipo_logradouro": "Rua", "bairro": "Centro", "cidade": "São Paulo", "cep": "04552999", "tipo": "mansao", "valor": 1000000.00, "data_aquisicao": "2022-05-30"}  
    }
    assert response.get_json() == expected_response