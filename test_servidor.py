...
def test_get_imoveis(mock_connect_db, client):
    ...
    expected_response = {
        "imoveis": [
            {"id": 1, "logradouro": "José Eiras Pinheiro", "tipo_logradouro": "Rua", "bairro": "Barra da Tijuca", "cidade": "Rio de Janeiro", "cep": "21240004", "tipo": "casa em condominio", "valor": 150000.00, "data_aquisicao": "2018-01-31"},
